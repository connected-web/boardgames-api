...
export default class CreatePlayrecordEndpoint extends OpenAPIFunction {
  constructor (scope: Construct, models: AppModels, config: StackParameters, bucket: s3.Bucket) {
    super('createPlayRecord')
    this.lambda = this.createNodeJSLambda(scope, 'routes/playrecords/create.ts', {
      environment: {
